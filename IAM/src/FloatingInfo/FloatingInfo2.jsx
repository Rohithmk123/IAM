...
function FloatingInfo2() {
  ...
  return (
    <div id="floatingInfo1" style={{ position: 'absolute', right: position, top: '900px', zIndex: '1', width: '350px', height: '300px', padding: '20px', backgroundColor: 'rgba(240, 240, 240, 0.8)', transition: 'right 0.5s ease-in-out', borderRadius:'50px' }}>
      ...
      <div>
        ...
        <p style={{ cursor: 'pointer', textDecoration: 'underline',textDecorationColorcolor:'black',textAlign: 'center' }}>
         <Link to="Staphylococcus_aureus"> 1 Staphylococcus aureus</Link>
        </p>
