        ...
        <div style={{ position: 'relative' }}>
          ...
          <div>
            <p style={{ cursor: 'pointer', textDecoration: 'underline', textAlign: 'center' }}>
              <h5 style={headingStyle}>Enterobacter spp</h5>
            </p>
          </div>
          <img
            src='/e facum.jpg' // Replace with the actual path to your image
            alt="Enterobacter spp Image"
          ...
          <div style={{ fontSize: '15px', paddingTop: '10px', color: 'purple' }}>
            ...
            <div style={{ marginLeft: '30%', textAlign: 'justify' }}>
              <h7 style={{ fontWeight: 'bold' }}>Infection </h7> : Various clinical syndromes, including
              bacteremia, lower respiratory tract infections, urinary tract infections, surgical site
              infections, and intravascular device-associated infections.
            </div>
          </div>
          <div style={{ textAlign: 'justify', color: 'purple' }}>
            The WHO listed carbapenem-resistant Enterobacteriaceae in 2017 as a concerning antibiotic-resistant
            group.
          </div>
        </div>
      </div>
