...
function Navbar2() {
  return (
    <nav className="navbar navbar-expand-lg navbar-dark fixed-top" style={{ background: '#07beb8' }}>
      <div className="container-fluid" style={{ height: '3rem' }}>
        <a className="navbar-brand" href="#" style={{  fontSize: '1.5rem' }}>
          <img src="/logo.PNG" alt="Logo" style={{ width: '4.375rem', height: '3.55rem', marginRight: '190.63%' }} />
        </a><h5 style={{ marginRight: '600px',fontSize:'25px', }}></h5>
        <button
        ...
        <div className="collapse navbar-collapse" id="navbarNavDropdown">
          <ul className="navbar-nav">
            <li className="nav-item">
              <a className="nav-link active" aria-current="page" href="#" style={{ color: '#4D0355', fontSize: '125%', marginRight: '20px' }}>
                Home
              </a>
            </li>
            <li className="nav-item">
